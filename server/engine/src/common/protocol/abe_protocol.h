...
enum abe_protocol_status {
    ABE_PROTOCOL_OK = ABE_OK,
    ABE_PROTOCOL_INVALID_ARG = ABE_INVALID_ARG,
    ABE_PROTOCOL_BUFFER_TOO_SMALL = ABE_BUFFER_TOO_SMALL,
    ABE_PROTOCOL_INVALID_MAGIC = ABE_INVALID_MAGIC,
    ABE_PROTOCOL_INVALID_VERSION = ABE_INVALID_VERSION,
    ABE_PROTOCOL_INVALID_LENGTH = ABE_INVALID_LENGTH
};
